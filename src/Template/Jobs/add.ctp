        ...
        <div class="row">
            ...
            <div class="col-sm-8 settings-body">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="date" value="" id="stellefreiab-input" name="available">
                    </div>
                </div>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        foreach ($contracts as $contract) {
                            echo "<option value=".$contract->id.">".$contract->contract."</option>";
                        } 
                        ?>
                        </select>
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="text" value="" id="titel-input" name="jobname">
                    </div>
                </div>
                <div class="form-group row">
                    <label for="stelle-textarea" class="col-sm-3 col-form-label">Description</label>
                    <div class="col-sm-9">
                        <textarea class="form-control" id="stelle-textarea" rows="10" name="description"></textarea>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-12">
